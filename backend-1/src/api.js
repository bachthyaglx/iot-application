...
router.get('/device/ports', middleware.tokenExtractor, middleware.optionalUserExtractor, device.getAllDevicePorts)
router.get('/device/port/:portId', middleware.tokenExtractor, middleware.optionalUserExtractor, device.getDevicePort)
...
router.put('/device/port/:portId', middleware.tokenExtractor, middleware.userExtractor, device.updateDevicePort)
